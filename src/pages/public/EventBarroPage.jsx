          ...
          <main>
            <section className="event-hero">
              <div className="event-container event-hero-grid">
                <div>
                  <span className="event-badge">AULÃO 100% GRATUITO • BARRO–CE</span>
                  <h1>ATENDIMENTO <em>PRÉ-HOSPITALAR</em></h1>
                  <p className="event-lead">
                    Um encontro presencial e intensivo de atualização em APH, com foco em emergências clínicas e trauma.
                    Conteúdo direto, raciocínio aplicado e prioridades que fazem diferença no atendimento.
                  </p>
                  <div className="event-pills">
                    <span className="event-pill">CLÍNICO + TRAUMA</span>
                    <span className="event-pill">PRESENCIAL</span>
                    <span className="event-pill">VAGAS LIMITADAS</span>
                  </div>
                </div>
